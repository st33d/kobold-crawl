...
= wait
{
            ...
            * * * [Wait.]
                ...
                * * * * [Wait.]
                    ...
                    * * * * * [Wait.]
                        ...
                        * * * * * * [Run through the room. (%{clamp(30 + wait * 10, 5, 95)})]-> run
                        * * * * * * [Wait.]
    ...
    -wait == 2:You wait whilst the roof of the room continues its slow creep downwards. A thump comes from inside the walls and it stops halfway. Is it broken?
        * * [Run through the room. (%{clamp(30 + wait * 10, 5, 95)})]You commit to running through and the ceiling begins to move again. <>-> run
        * * [Wait.]
...
<- rollChance(clamp(30 + wait * 10, 5, 95))
{
- isSuccess:-> success
- else: -> failure
}
